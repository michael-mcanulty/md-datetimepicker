...
var MdMonthView = (function () {
    ...
    Object.defineProperty(MdMonthView.prototype, "timepickerAttrs", {
    ...
    MdMonthView.prototype._dateSelected = function (date) {
        ...
        var defaultHours = this.timepickerAttrs.defaultHour || this._dateAdapter.getHours(this.activeDate);
        var defaultMinutes = this.timepickerAttrs.defaultMinute || this._dateAdapter.getMinutes(this.activeDate);
