...
var MdDatetimepickerInput = (function () {
    ...
    MdDatetimepickerInput.prototype.isTouch = function () {
    ...
    Object.defineProperty(MdDatetimepickerInput.prototype, "date", {
    ...
    Object.defineProperty(MdDatetimepickerInput.prototype, "hideTime", {
    ...
    MdDatetimepickerInput.prototype.dateFormatting = function (isParse) {
        var _input = (this.hideTime) ? 'dateInput' : 'datetimeInput';
    ...
    Object.defineProperty(MdDatetimepickerInput.prototype, "value", {
        ...
        get: function () {
            var parse_format = this.dateFormatting(true);
            return this._dateAdapter.parse(this._elementRef.nativeElement.value, parse_format);
        },
        set: function (value) {
            var parse_format = this.dateFormatting(true);
            var display_format = this.dateFormatting(false);
