 ...
 */
import { ChangeDetectionStrategy, Component, Input, ViewEncapsulation, ElementRef, Renderer2 } from '@angular/core';
import { MdDatetimepickerIntl } from './datetimepicker-intl';
var MdDatetimepickerToggle = (function () {
    function MdDatetimepickerToggle(_intl, _elm, _renderer) {
        this._intl = _intl;
        this._elm = _elm;
    ...
    MdDatetimepickerToggle.prototype.ngAfterContentInit = function () {
        if (!this.color) {
...
MdDatetimepickerToggle.decorators = [
    { type: Component, args: [{
                ...
                template: '',
                styles: [".mat-datepicker-toggle{display: inline-block; height: 24px; width: 24px; padding: 0; margin: 0; border: none; outline:none; background: transparent;}.mat-datepicker-toggle:not([disabled]){cursor: pointer;}"],
                host: {
                    'type': 'button',
