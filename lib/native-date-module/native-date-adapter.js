...
var NativeDateAdapter = (function (_super) {
    ...
    NativeDateAdapter.prototype.getNumDaysInMonth = function (date) {
        return this.getDate(this._createDateWithOverflow(this.getYear(date), this.getMonth(date) + 1, 0, this.getHours(date), this.getMinutes(date)));
    };
    ...
    NativeDateAdapter.prototype.today = function () {
        var date = new Date();
        var now = this.createDate(this.getYear(date), this.getMonth(date), this.getDate(date), this.getHours(date), this.getMinutes(date));
        return now;
    };
    ...
    NativeDateAdapter.prototype.addCalendarMonths = function (date, months) {
        ...
        if (this.getMonth(newDate) != ((this.getMonth(date) + months) % 12 + 12) % 12) {
            newDate = this._createDateWithOverflow(this.getYear(newDate), this.getMonth(newDate), 0, this.getHours(date), this.getMinutes(date));
        }
        return newDate;
    };
    ...
    NativeDateAdapter.prototype._createDateWithOverflow = function (year, month, date, hours, minutes) {
        var result = new Date(year, month, date, hours || 0, minutes || 0, 0, 0);
    ...
    NativeDateAdapter.prototype.createDate = function (year, month, date, hours, minutes) {
    ...
    NativeDateAdapter.prototype.setHours = function (date, hours) {
        var result = date || new Date();
        result.setHours(hours);
        return result;
    };
    NativeDateAdapter.prototype.setMinutes = function (date, minutes) {
        var result = date || new Date();
        result.setMinutes(minutes);
        return result;
    };
    NativeDateAdapter.prototype.setSeconds = function (date) {
        var result = date || new Date();
        result.setSeconds(0);
    ...
    NativeDateAdapter.prototype.isPm = function (date) {
        return (date.getHours() > 11) ? true : false;
    };
    NativeDateAdapter.prototype.getMinutes = function (date) {
        return date.getMinutes();
    };
    NativeDateAdapter.prototype.is12Hour = function () {
        var date = new Date(Date.UTC(2016, 11, 12, 3, 0, 0));
    ...
    NativeDateAdapter.prototype.toLocaleTimeString = function (date) {
